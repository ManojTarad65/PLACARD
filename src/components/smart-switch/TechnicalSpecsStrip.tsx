export default function TechnicalSpecsStrip() {
  const specs = [
    { label: "OPERATING VOLTAGE", value: "110-240V AC" },
    { label: "MAX LOAD", value: "10A / 2000W" },
    { label: "COMMUNICATION", value: "Wi-Fi / Zigbee" },
    { label: "CERTIFICATION", value: "CE, RoHS" },
  ];

  return (
    <section className="w-full bg-primary text-on-primary py-12 border-y border-outline overflow-hidden relative" id="specs">
